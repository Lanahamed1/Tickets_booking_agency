...
class RReservationCard extends StatelessWidget {
  final RReservation reservation;

  RReservationCard({required this.reservation});
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      Text(reservation.return_currentAirport,
                          style: Styles.headLineStyle31),
                      Text(reservation.return_destinationAirport,
                          style: Styles.headLineStyle31),
                    ],
                  ),
                  const Row(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      Text(reservation.returnDepartureDate?.toString() ?? '',
                          style: Styles.headLineStyle31),
                    ],
                  ),
                  const SizedBox(height: 5),
