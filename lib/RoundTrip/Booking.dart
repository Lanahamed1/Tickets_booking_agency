...
class RBooking extends StatelessWidget {
  final int return_flight;
  final int outbound_flight;

  RBooking({required this.return_flight, required this.outbound_flight});
  final RBookingController controller = Get.put(RBookingController());
                    ...
                    child: MaterialButton(
                      onPressed: () async {
                        ...
                        await controller.submitBooking(
                            return_flight, outbound_flight);
                        await Get.to(() => RReservationView(
