...
import 'package:flutter_tickets_booking_agency/RoundTrip/tickets_controller.dart';
...
class RTicketScreen extends StatelessWidget {
  const RTicketScreen({
  ...
  Widget build(BuildContext context) {
    ...
    final RTicketController controller = Get.put(RTicketController());

    controller.rfetchTicketDetails(_Controller.bookingIds);
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          RoundShape(shapeColor: Colors.blue),
                          const Spacer(flex: 1),
                          Text(ticket.destinationAirport,
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            children: [
                              Text(
                                  '${ticket.passengerName}${ticket.passengername}',
                                  style: Styles.headLineStyle37
                                      .copyWith(color: Colors.black)),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              Text('${ticket.passenger_class}'.toString(),
                                  style: Styles.headLineStyle37
                                      .copyWith(color: Colors.black)),
                              Gap(AppLayout.getHeight(5)),
                              Text("Price", style: Styles.headLineStyle37)
