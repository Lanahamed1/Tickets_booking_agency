...
class Styles {
  ...
  static TextStyle headLineStyle32 = const TextStyle(
      ...
      color: Colors.white,
      fontWeight: FontWeight.w500);
  static TextStyle headLineStyle33 = const TextStyle(
      fontSize: 16,
      color: Color.fromARGB(255, 2, 146, 219),
      fontWeight: FontWeight.w700);
  static TextStyle headLineStyle34 =
      TextStyle(fontSize: 16, color: textColor2, fontWeight: FontWeight.w600);
  static TextStyle textStyle2 =
      TextStyle(fontSize: 16, color: textColor, fontWeight: FontWeight.w500);
  static TextStyle headLineStyle35 =
      TextStyle(fontSize: 24, color: textColor, fontWeight: FontWeight.bold);
  static TextStyle headLineStyle36 =
      TextStyle(fontSize: 21, color: textColor, fontWeight: FontWeight.bold);
  static TextStyle headLineStyle37 = TextStyle(
      fontSize: 17, color: Colors.grey.shade500, fontWeight: FontWeight.w500);
  static TextStyle headLineStyle38 = TextStyle(
      fontSize: 14, color: Colors.grey.shade500, fontWeight: FontWeight.w500);
}
